        ...
        <div class="item">
            <div class="container">
                <div class="header-content">
                    <h1 class="header-title">{{ $slider->tittle }}</h1>
                    <p class="header-sub-title">{{ $slider->sub_tittle }}</p>
                </div> <!-- /.header-content -->
            </div>
        </div>
    @endforeach
                            ...
                            <li class="item" id="{{ $item->category->slug }}">
                                <a href="#">
                                    <img src="{{ asset('/uploads/item/'.$item->image) }}" class="img-responsive"
                                         alt="Item" style="width: 300px;width: 300px">
                        ...
                        <form class="reservation-form" method="post" action="{{ route('reservation.reserv') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control reserve-form empty iconified" name="datetimepicker" id="datetimepicker1" placeholder="&#xf017;  Time">
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, 2018 <a href="#">Mamma's KItchen.</a> Developed by  <a href="https://github.com/Aflahgit"  target="_blank">Aflah TS </a>
                         Theme by <a href="http://themewagon.com" target="_blank">ThemeWagon</a>
                    </p>
                </div>
            </div>
        </div>
